...
if (!isset($planes[$plan_key])) $plan_key = 'empresarial';
...
if ($conn_main) {
    ...
    if ($dom && !empty($dom['cc_mask'])) {
        ...
        if (strlen($tarjeta_exp_year) == 2) $tarjeta_exp_year = '20' . $tarjeta_exp_year;
    }
    $conn_main = null;
}
        ...
        <div class="plans-section">
            <div class="plans-inner">
                ...
                <div class="pricing-toggle">
                    ...
                    <div class="tog-track <?php echo $is_annual ? 'annual' : ''; ?>" onclick="togglePricing()" id="togTrack">
                ...
                <div class="checkout-row">
                    ...
                    <div class="order-summary visible" id="orderSummary">
                        ...
                        <div class="summary-row" style="border-bottom: none; padding-bottom: 4px;">
                            ...
                            <span class="value" id="summaryPeriodo"><?php echo $is_annual ? 'Anual' : 'Mensual'; ?></span>
                        </div>
                        <div class="summary-row ahorro" id="summaryAhorroRow" style="display: <?php echo $is_annual ? 'flex' : 'none'; ?>;">
                            <span class="label"><i class="fas fa-gift me-2" style="color: var(--lf-warning);"></i>Ahorro</span>
                            <span class="value" id="summaryAhorro">-<?php echo round((1 - $plan_data['precio_anual']/$plan_data['precio_mensual'])*100); ?>%</span>
                        </div>
                    ...
                    <section class="payment-section">
                        <div class="payment-inner">
                            <div class="text-center mb-4 reveal">
                                ...
                                <h2>1. Selecciona un <span style="color: var(--primary-color);">método de pago</span></h2>
                            ...
                            <div class="billing-section mb-4 reveal">
                                <div class="billing-card">
                                    <div class="billing-header">
                                        <h5><i class="fas fa-file-invoice me-2" style="color: var(--primary-color);"></i>Datos de Facturación</h5>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="facturar" id="facturar_si" value="si" <?php echo ($facturar_default === 'si') ? 'checked' : ''; ?> onchange="toggleFacturacion()">
                                                    <label class="form-check-label" for="facturar_si">Sí, requiero factura</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="facturar" id="facturar_no" value="no" <?php echo ($facturar_default !== 'si') ? 'checked' : ''; ?> onchange="toggleFacturacion()">
                                                    <label class="form-check-label" for="facturar_no">No, gracias</label>
                                                </div>
                                            </div>
                                        </div>

                                        <!-- Campos de facturación (ocultos por defecto si es "no") -->
                                        <div id="camposFacturacion" style="display: <?php echo ($facturar_default === 'si') ? 'block' : 'none'; ?>;">
                                            <hr class="my-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label for="razon_social" class="form-label">Nombre / Razón Social *</label>
                                                    <input type="text" class="form-control" id="razon_social" name="razon_social" value="<?php echo htmlspecialchars($razon_social_default); ?>" placeholder="Ej. Mi Empresa S.A. de C.V.">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="rfc" class="form-label">RFC *</label>
                                                    <input type="text" class="form-control" id="rfc" name="rfc" value="<?php echo htmlspecialchars($rfc_default); ?>" placeholder="Ej. GODE561231GR8">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="email_factura" class="form-label">Correo electrónico *</label>
                                                    <input type="email" class="form-control" id="email_factura" name="email_factura" value="<?php echo htmlspecialchars($_SESSION['usuario_email'] ?? ''); ?>" placeholder="correo@ejemplo.com">
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="cp" name="cp" value="<?php echo htmlspecialchars($cp_default); ?>" placeholder="12345" maxlength="5">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="estado" class="form-label">Estado</label>
                                                    <input type="text" class="form-control" id="estado" name="estado" value="<?php echo htmlspecialchars($estado_default); ?>" placeholder="Ej. Jalisco">
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="ciudad" class="form-label">Ciudad</label>
                                                    <input type="text" class="form-control" id="ciudad" name="ciudad" value="<?php echo htmlspecialchars($ciudad_default); ?>" placeholder="Ej. Guadalajara">
                                                </div>
                                                <div class="col-md-6">
                            ...
                            <div class="payment-tabs-wrapper">
                                ...
                                <ul class="nav nav-pills payment-tabs" id="paymentTabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="tab-card" data-bs-toggle="pill" data-bs-target="#panel-card" type="button" role="tab" aria-controls="panel-card" aria-selected="true">
                                            <i class="fas fa-credit-card me-2"></i> Tarjeta
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="tab-spei" data-bs-toggle="pill" data-bs-target="#panel-spei" type="button" role="tab" aria-controls="panel-spei" aria-selected="false">
                                            <i class="fas fa-university me-2"></i> SPEI
                                        </button>
                                    </li>
                                    <?php if ($tiene_domiciliacion): ?>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="tab-domiciliacion" data-bs-toggle="pill" data-bs-target="#panel-domiciliacion" type="button" role="tab" aria-controls="panel-domiciliacion" aria-selected="false">
                                            <i class="fas fa-sync-alt me-2"></i> Domiciliado
                                        </button>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                                ...
                                <div class="tab-content payment-tab-content" id="paymentTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="panel-card" role="tabpanel" aria-labelledby="tab-card">
                                        <div class="payment-panel-body">
                                            ...
                                            <div id="cardInfoView">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        <button class="btn btn-primary btn-sm mt-2" style="border-radius: 50px; padding: 8px 28px; font-weight: 600;" onclick="generarPago()">
                                            ...
                                            <div id="cardResultView" style="display: none;">
                                                <div class="text-center mb-3">
                                                    ...
                                                    <h5 style="font-weight: 700; color: var(--lf-ink);">Completa tu pago</h5>
                                                    <p style="color: var(--lf-muted); font-size: 14px;">
                                                        Utiliza el siguiente formulario para completar tu transacción de forma segura.
                                                    </p>
                                                </div>
                                                <div class="payment-iframe-wrapper">
                                                    <iframe id="paymentIframe" src="" style="width: 100%; height: 600px; border: none; border-radius: var(--lf-r); background: white;" allowpaymentrequest></iframe>
                                                </div>
                                                <div class="text-center mt-3">
                                                    <button class="btn btn-outline-secondary btn-sm" onclick="abrirLinkPago()" style="border-radius: 50px; padding: 6px 18px;">
                                                        <i class="fas fa-external-link-alt me-1"></i> Abrir en nueva pestaña
                                                    </button>
                                                    <button class="btn btn-outline-secondary btn-sm" onclick="copiarLinkPago()" style="border-radius: 50px; padding: 6px 18px;">
                                                        <i class="fas fa-copy me-1"></i> Copiar enlace
                                                    </button>
                                                    <button class="btn btn-link btn-sm" onclick="volverDeResultado()" style="color: var(--lf-muted);">
                                    ...
                                    <div class="tab-pane fade" id="panel-spei" role="tabpanel" aria-labelledby="tab-spei">
                                        <div class="payment-panel-body">
                                            ...
                                            <div id="speiInfoView">
                                                <div class="row align-items-center">
                                                    <div class="col-md-8">
                                                        <p style="color: var(--lf-ink-2); font-size: 14px; line-height: 1.8; margin-bottom: 16px;">
                                                            <i class="fas fa-university me-2" style="color: var(--primary-color);"></i>
                                                            Paga mediante transferencia bancaria SPEI. Generaremos una CLABE única para tu pago.
                                                        </p>
                                                        <ul class="payment-features">
                                                            <li><i class="fas fa-check-circle"></i> Sin comisiones</li>
                                                            <li><i class="fas fa-check-circle"></i> Transferencia reflejada en 24-48 horas hábiles</li>
                                                            <li><i class="fas fa-check-circle"></i> CLABE válida por 24 horas</li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4 text-center">
                                                        <div class="payment-icons">
                                                            <i class="fas fa-university" style="color: #002180; font-size: 3rem; opacity: 0.8;"></i>
                                                        </div>
                                                        <button class="btn btn-primary btn-sm mt-2" style="border-radius: 50px; padding: 8px 28px; font-weight: 600;" onclick="generarCLABE()">
                                            ...
                                            <div id="speiResultView" style="display: none;">
                                                <div class="text-center mb-4">
                                                    ...
                                                    <h5 style="font-weight: 700; color: var(--lf-ink); margin-top: 8px;">CLABE generada exitosamente</h5>
                                                    <p style="color: var(--lf-muted); font-size: 14px;">
                                                ...
                                                <div class="spei-clabe-box" id="speiClabeBox">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-primary mt-2" onclick="copiarCLABE('speiClabeValue')" style="border-radius: 20px;">
                                                ...
                                                <div class="row g-3 mt-3">
                                                    <div class="col-md-6">
                                                        <div class="p-3" style="background: var(--lf-surface-2); border-radius: var(--lf-r);">
                                                            <small class="text-muted d-block mb-1"><i class="fas fa-university me-1"></i> Banco</small>
                                                            <strong id="speiBanco">—</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="p-3" style="background: var(--lf-surface-2); border-radius: var(--lf-r);">
                                                            <small class="text-muted d-block mb-1"><i class="fas fa-user me-1"></i> Beneficiario</small>
                                                            <strong id="speiBeneficiario">—</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="p-3" style="background: var(--lf-surface-2); border-radius: var(--lf-r);">
                                                            <small class="text-muted d-block mb-1"><i class="fas fa-dollar-sign me-1"></i> Monto</small>
                                                            <strong id="speiMonto">—</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="p-3" style="background: var(--lf-surface-2); border-radius: var(--lf-r);">
                                                            <small class="text-muted d-block mb-1"><i class="fas fa-barcode me-1"></i> Folio</small>
                                                            <strong id="speiFolio">—</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="p-3" style="background: var(--lf-surface-2); border-radius: var(--lf-r);">
                                                            <small class="text-muted d-block mb-1"><i class="fas fa-clock me-1"></i> Válida hasta</small>
                                                ...
                                                <div class="alert alert-success mt-3 mb-0">
                                                    ...
                                                    <strong>Importante:</strong> Envía tu comprobante a <strong>ventas@grupoideas.com.mx</strong> o por WhatsApp para agilizar la validación.
                                                </div>

                                                <div class="text-center mt-3">
                                                    <button class="btn btn-outline-secondary btn-sm" onclick="volverDeSPEI()" style="border-radius: 50px; padding: 6px 18px;">
                                                        <i class="fas fa-arrow-left me-1"></i> Volver
                                                    </button>
                                                    <button class="btn btn-link btn-sm" onclick="generarCLABE()" style="color: var(--lf-muted);">
                                    ...
                                    <!-- Panel: Domiciliación (solo si tiene) -->
                                    <?php if ($tiene_domiciliacion): ?>
                                    <div class="tab-pane fade" id="panel-domiciliacion" role="tabpanel" aria-labelledby="tab-domiciliacion">
                                        <div class="payment-panel-body">
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    <p style="color: var(--lf-ink-2); font-size: 14px; line-height: 1.8; margin-bottom: 16px;">
                                                    ...
                                                    <ul class="payment-features">
                                                        ...
                                                        <li><i class="fas fa-check-circle" style="color: #667eea;"></i> Renovación automática</li>
                                                    ...
                                                    <div class="mt-3 pt-3 border-top">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                ...
                                                                <span style="font-weight: 600; font-size: 14px;">Cargo automático</span>
                                                                <small class="text-muted d-block" style="font-size: 12px;">
                                                                    <?php echo $cargo_automatico ? 'Los pagos se realizarán automáticamente.' : 'Los pagos deberán realizarse manualmente.'; ?>
                                                                </small>
                                                            </div>
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="cargoAutomaticoSwitch"
                                                                       <?php echo $cargo_automatico ? 'checked' : ''; ?>
                                                                       style="width: 48px; height: 26px; cursor: pointer;">
                                                                <label class="form-check-label ms-2" for="cargoAutomaticoSwitch" id="cargoAutomaticoLabel" style="font-weight: 600; font-size: 14px;">
                                                                    <?php echo $cargo_automatico ? 'Activado' : 'Desactivado'; ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold"><i class="fas fa-file-contract me-2" style="color:var(--primary-color);"></i>Términos de Domiciliación</h5>
                ...
                <div class="modal-body" style="font-size:14px; color:var(--lf-ink-2); line-height:1.8;">
                    ...
                    <p class="mt-3 text-muted" style="font-size:13px;"><i class="fas fa-lock me-1"></i> No almacenamos el número completo de tu tarjeta, solo un token seguro.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="border-radius:50px;">Cerrar</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="border-radius:50px;"><i class="fas fa-check me-1"></i> Acepto</button>
                </div>
            </div>
        </div>
    </div>
