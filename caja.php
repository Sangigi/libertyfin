...
$FACTURAPI_SECRET_KEY = "sk_user_qQMnptmpV3FM1iMrTyQPx65uXZbknSt8vYQbjWiDuK";
                ...
                if ($stmt) {
                    ...
                    if ($costo_total_venta > 0) {
                        ...
                        if ($stmt) {
                            ...
                            if (!$stmt->execute()) {
                                error_log("⚠️ ERROR al registrar gasto automático de la venta $venta_id: " . $stmt->error);
                            } else {
                                error_log("✅ Gasto automático registrado para la venta $venta_id - Monto: $costo_total_venta");
                            }
                            $stmt->close();
                        } else {
                            error_log("❌ ERROR al preparar el registro de gasto automático: " . $conn->error);
                        }
                    }
