...
try {
    ...
    $sql = "SELECT 
                ...
                e.nombre_empresa,
                e.giro_comercial,
                g.nombre as nombre_giro_comercial,
                e.rfc,
                e.telefono,
                e.email,
                e.direccion,
    ...
    if (!empty($empresa['nombre_base_datos'])) {
        try {
            ...
            $conn_empresa = getEmpresaDBConnection($empresa['nombre_base_datos']);
            ...
            try {
                ...
                if ($result_sucursales) {
                    $row_suc = $result_sucursales->fetch();
                    $estadisticas['sucursales'] = $row_suc['total'] ?? 0;
                }
            } catch (PDOException $e) {
                // Tabla no existe, mantener 0
            }
            ...
            try {
                ...
                if ($result_productos) {
                    $row_prod = $result_productos->fetch();
            ...
            try {
                ...
                if ($result_proveedores) {
                    $row_prov = $result_proveedores->fetch();
            ...
            $conn_empresa = null; // Cerrar conexión
    ...
    function mostrarPlan($plan)
    {
        $planes = [
            ...
            'basico' => ['texto' => 'Básico', 'clase' => 'info'],
            'starter' => ['texto' => 'Profesional', 'clase' => 'primary'],
            'emprendedor' => ['texto' => 'Empresarial', 'clase' => 'warning'],
            'premium' => ['texto' => 'Empresarial Plus', 'clase' => 'success']
        ];
...
<div class="detalle-empresa-container">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="info-item mb-3">
                                <label class="form-label text-muted small mb-1 d-flex align-items-center">
                                    <i class="fas fa-shield-alt me-2 fa-sm" style="width: 20px;"></i>Estado Verificación
                                </label>
                                <div class="fw-semibold ps-4">
    ...
    <div class="mt-4 pt-3 border-top text-end">
        <button type="button" class="btn btn-warning btn-lg" onclick="abrirModalEditar(<?php echo $empresa['id']; ?>)">
