...
$('#subprecio_desktop, #subprecio_mobile').on('input', function() {
    ...
    calcularPrecioDesdeDescuento();
            ...
            function nuevoProducto() {
                if (window.LFG_LIMITE_ALCANZADO) {
                    mostrarMensajeTemporal('Ha alcanzado el límite de productos para su plan (' + window.LFG_LIMITE_PRODUCTOS + ' productos). Actualice su plan.', 'danger');
                    return;
                }
